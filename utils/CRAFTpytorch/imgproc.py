...
# img = torch.clone(in_img)
# img -= torch.tensor([mean[0] * 255.0, mean[1] * 255.0, mean[2] * 255.0]).reshape(1,3,1,1).cuda()
# img /= torch.tensor([variance[0] * 255.0, variance[1] * 255.0, variance[2] * 255.0]).reshape(1,3,1,1).cuda()
# return img
